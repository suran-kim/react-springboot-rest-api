...
@SpringBootTest // SpringBootTest는 SpringBootApplication을 자동으로 찾아준다.  ->  SpringConfiguration을 자동으로 찾는다: Bean설정을 읽어서 컨테이너를 만들어준다.
...
class ProductJdbcRepositoryTest {
    ...
    // 테스트를 위한 product 객체
    private final Product newProduct = new Product(UUID.randomUUID(), "new-product", Category.COFFEE_BEAN_PACKAGE, 1000L); // static으로 생성해야 테스트마다 인스턴스가 생성되지 않는다.
